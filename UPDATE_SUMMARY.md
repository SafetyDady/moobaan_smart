...
> **อัปเดตล่าสุด:** 14 กุมภาพันธ์ 2569 | **Latest Commit:** `e5d0143`
...
- 🧾 Resident Dashboard — Compact hero (ยอดค้าง/เกิน) + Invoice Table (status สี: เขียว=ชำระแล้ว, แดง=เกินกำหนด, เหลือง=รอชำระ)
